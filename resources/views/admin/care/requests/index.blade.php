...
@section('title', 'طلبات الرعاية')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold">طلبات الرعاية</h4>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.care.requests') }}" class="row g-3">
                <div class="col-md-5">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.care.requests') }}" class="btn btn-outline-secondary w-100">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.care.requests.show', $req) }}"
