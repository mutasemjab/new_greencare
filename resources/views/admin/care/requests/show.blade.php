...
@section('title', 'تفاصيل طلب الرعاية')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('admin.care.requests') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-right"></i>
        </a>
        <h4 class="mb-0 fw-bold">طلب رعاية #{{ $request->id }}</h4>
        @php
            $statusMap = [
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-transparent fw-bold">
                    <i class="bi bi-info-circle me-2"></i>معلومات العميل
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-sm-6">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent fw-bold">
                    <i class="bi bi-heart-pulse me-2"></i>الخدمات المطلوبة
                </div>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($service->pivot->price ?? $service->price, 2) }} JD</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot class="table-light">
                                <tr>
                                    <td class="fw-bold fs-5">الإجمالي</td>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.care.requests.status', $request) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="mb-3">
