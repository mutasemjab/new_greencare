...
<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <h4 class="mb-0 fw-bold">إضافة حقل لنموذج الزيارة الطبية</h4>
    </div>

    <div class="card border-0 shadow-sm mx-auto" style="max-width:700px;">
        <div class="card-body p-4">
            <form action="{{ route('admin.sihati.visit-form-fields.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="field_type" id="fieldType" class="form-select @error('field_type') is-invalid @enderror" required>
                        ...
                        <option value="choice"    {{ old('field_type') === 'choice' ? 'selected' : '' }}>اختيار واحد</option>
                        <option value="checklist" {{ old('field_type') === 'checklist' ? 'selected' : '' }}>اختيار متعدد</option>
                    </select>
