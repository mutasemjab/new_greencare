...
@section('title', 'تفاصيل طلب الأشعة')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('admin.xray.requests') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-right"></i>
        </a>
        <h4 class="mb-0 fw-bold">طلب أشعة #{{ $request->id }}</h4>
        @php
            $statusMap = [
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent fw-bold">
                    <i class="bi bi-radioactive me-2"></i>الأشعة المطلوبة
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.xray.requests.status', $request) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="mb-3">
