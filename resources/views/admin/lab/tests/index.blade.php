...
@section('title', 'فحوصات المختبر')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold">فحوصات المختبر</h4>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.lab.tests') }}" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.lab.tests') }}" class="btn btn-outline-secondary w-100">
