...
@section('title', 'تعديل فئة المختبر')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('admin.lab.categories') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card border-0 shadow-sm mx-auto" style="max-width:700px;">
        <div class="card-body p-4">
            <form action="{{ route('admin.lab.categories.update', $category) }}" method="POST"
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.lab.categories') }}" class="btn btn-outline-secondary px-4">إلغاء</a>
                </div>
