...
@section('title', 'تفاصيل طلب التمريض')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('admin.nursing.requests') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-right"></i>
        </a>
        <h4 class="mb-0 fw-bold">طلب تمريض #{{ $request->id }}</h4>
        @php
            $statusMap = [
    ...
    <div class="row g-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="fw-semibold">{{ $request->nursingType?->name ?? '—' }}</div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="fw-semibold">{{ $request->nursingType ? number_format($request->nursingType->price, 2) . ' JD' : '—' }}</div>
                        </div>
                        @if($request->address)
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="fw-semibold">{{ $request->notes }}</div>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.nursing.requests.status', $request) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="mb-3">
