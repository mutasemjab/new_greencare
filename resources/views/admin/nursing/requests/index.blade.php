...
@section('title', 'طلبات التمريض')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 fw-bold">طلبات التمريض</h4>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.nursing.requests') }}" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.nursing.requests') }}" class="btn btn-outline-secondary w-100">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $req->nursingType?->name ?? '—' }}</td>
                            <td>{{ $req->booking_date ? \Carbon\Carbon::parse($req->booking_date)->format('Y/m/d') : '—' }}</td>
                            <td>{{ $req->booking_time ?? '—' }}</td>
                            <td>
                                <span class="badge {{ $st['class'] }}">{{ $st['label'] }}</span>
                            </td>
                            <td>
                                <a href="{{ route('admin.nursing.requests.show', $req) }}"
