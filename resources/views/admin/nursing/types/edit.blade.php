...
@section('title', 'تعديل نوع التمريض')

@section('content')
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('admin.nursing.types') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-right"></i>
        </a>
        <h4 class="mb-0 fw-bold">تعديل النوع: {{ $type->name }}</h4>
    </div>
    ...
    <div class="card border-0 shadow-sm mx-auto" style="max-width:700px;">
        <div class="card-body p-4">
            <form action="{{ route('admin.nursing.types.update', $type) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ Storage::url($type->icon) }}" alt="{{ $type->name }}"
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold">{{ $type->icon ? 'تغيير الأيقونة' : 'الأيقونة / الصورة' }}</label>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.nursing.types') }}" class="btn btn-outline-secondary px-4">إلغاء</a>
                </div>
