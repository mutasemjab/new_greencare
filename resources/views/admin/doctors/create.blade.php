...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        <a href="{{ route('admin.doctors.index') }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-right"></i></a>
        <h4 class="mb-0 fw-bold">إضافة طبيب جديد</h4>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="home_visit_price" step="0.01" min="0"
                            ...
                            value="{{ old('home_visit_price', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="appointment_price" step="0.01" min="0"
                            ...
                            value="{{ old('appointment_price', 0) }}" required>
                        @error('appointment_price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label fw-semibold">التقييم (1-5) <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="years_experience" min="0"
                            ...
                            value="{{ old('years_experience', 0) }}" required>
