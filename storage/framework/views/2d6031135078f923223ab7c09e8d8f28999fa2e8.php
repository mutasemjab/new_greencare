<?php $__env->startSection('title', 'إضافة حساب مختبر'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">

    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="<?php echo e(route('admin.lab.staff.index')); ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card border-0 shadow-sm mx-auto" style="max-width:700px;">
        <div class="card-body p-4">
            ...
            <form action="<?php echo e(route('admin.lab.staff.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.lab.staff.index')); ?>" class="btn btn-outline-secondary px-4">إلغاء</a>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\green\resources\views/admin/lab/staff/create.blade.php ENDPATH**/ ?>