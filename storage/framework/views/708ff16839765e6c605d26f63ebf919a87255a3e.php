...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .l-brand-name span { color: #86efac; }
        ...
        .form-input:focus {
            border-color: #33A552;
            box-shadow: 0 0 0 3px rgba(51,165,82,.12);
        }
        ...
        .btn-login:hover {
            background: #278a44;
            box-shadow: 0 4px 14px rgba(51,165,82,.4);
        ...
        .r-footer a { color: #33A552; font-weight: 500; text-decoration: none; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="r-footer">
            &copy; <?php echo e(date('Y')); ?> Green Care. <?php echo e(__('messages.all_rights_reserved')); ?>
...
<?php /**PATH C:\xampp\htdocs\green\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>