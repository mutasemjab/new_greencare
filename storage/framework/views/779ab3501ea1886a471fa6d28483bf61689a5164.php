...
<body>
    <div class="card-login">
        ...
        <form method="POST" action="<?php echo e(route('lab.login')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label class="form-label" for="phone">رقم الهاتف</label>
                <input id="phone" name="phone" type="text"
                    class="form-input <?php echo e($errors->has('phone') ? 'is-invalid' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input id="password" name="password" type="password"
                    class="form-input <?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>" required>
...
<?php /**PATH C:\xampp\htdocs\green\resources\views/lab/auth/login.blade.php ENDPATH**/ ?>